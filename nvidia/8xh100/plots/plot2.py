...
if filtered_df.empty:
    ...
    aggregated_df = filtered_df.groupby(['qps', num_scheduler_step_col])['request_throughput'].mean().reset_index()
    ...
    plt.title('Throughput(Request per Second) vs QPS for Different Scheduler Steps', fontsize=18)
    ...
    plt.savefig('request_throughput_vs_qps_scheduler_steps_contrasting_colors.png', dpi=300, bbox_inches='tight')
