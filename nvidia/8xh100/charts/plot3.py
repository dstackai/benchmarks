...
if filtered_df.empty:
    ...
    aggregated_df = filtered_df.groupby(['qps', enable_chunked_prefill_col])['mean_ttft_ms'].mean().reset_index()
    ...
    plt.title('Mean TTFT (ms) vs QPS for Different Enable Chunked Prefill Settings', fontsize=18)
    ...
    plt.savefig('mean_ttft_vs_qps_enable_chunked_prefill_contrasting_colors.png', dpi=300, bbox_inches='tight')
