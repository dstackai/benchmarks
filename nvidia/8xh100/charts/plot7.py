...
plt.title('Tokens Per Second vs Batch Size (Input_len=128, Out_len=2048)', fontsize=18)
...
# Save the plot
plt.savefig('tokens_per_second_vs_batch_size_128_2048.png', dpi=300, bbox_inches='tight')
