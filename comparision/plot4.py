...
plt.title('Request Throughput(request/s) vs QPS for Different GPUs', fontsize=18)
...
# Save the plot
plt.savefig('charts/request_throughput_vs_qps_comparison_gpus.png', dpi=300, bbox_inches='tight')
