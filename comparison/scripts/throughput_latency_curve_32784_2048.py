...
def main(input_file, output_file):
    ...
    # Read the CSV file
    # df = pd.read_csv('latency_comparison_32784_2048.csv')
    ...
    plt.title('Throughput Vs Latency (input_len=32784, output_len=2048)', fontsize=18)
    ...
    # Save the plot
    # plt.savefig('images/tokens_per_second_vs_end_to_end_latency_comparison_gpus_32784_2048.png', dpi=300, bbox_inches='tight')
